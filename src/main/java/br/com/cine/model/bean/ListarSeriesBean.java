...
public class ListarSeriesBean implements TipoAcao {
    private HttpServletRequest req;
    private HttpServletResponse resp;

    public ListarSeriesBean(HttpServletRequest req, HttpServletResponse resp) {
        this.req = req;
        this.resp = resp;
    }
    ...
    public void execute() throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = this.req.getRequestDispatcher("/series.jsp");
