...
public class ListarAdmPorIDBean implements TipoAcao {
    private HttpServletRequest req;
    private HttpServletResponse resp;

    public ListarAdmPorIDBean(HttpServletRequest req, HttpServletResponse resp) {
        this.req = req;
        this.resp = resp;
    }
    ...
    public void execute() throws ServletException, IOException {
        ...
        try {
            ...
            if (usuarioEncontrado.isPresent()) {
                ...
                this.req.getRequestDispatcher("/form-alterar-adm.jsp").forward(this.req, this.resp);
            } else {
